    ...
    <div className="absolute w-full bg-white text-black top-0 h-[100vh] z-50 bg-[#80808026] flex">
      <div className="h-full w-full p-2 md:p-4 md:h-full lg:h-fit lg:p-8 lg:w-[480px] bg-infosBarBg m-auto relative shadow-2xl">
        ...
        <form onSubmit={(e) => handleForm(e)}>
          ...
          ></input>
          <label htmlFor="lastname" className="w-full block text-xl mt-2">
            Nom
          </label>
          <input
            type="text"
            ...
            className="w-full block h-9 rounded-sm"
          ></input>
          <label htmlFor="email" className="w-full block text-xl mt-2">
            Email
          </label>
          <input
            type="email"
            ...
            className="w-full block h-9 rounded-sm"
          ></input>
          <label htmlFor="textarea" className="w-full block text-xl mt-2">
            Votre message
          </label>
          <textarea
            id="textarea"
